...
+function ($) {
  ...
  SPPBTab.prototype.show = function () {
    ...
    var e        = $.Event('http://avtoservice.ssd-media.ru/components/com_sppagebuilder/assets/js/show.sppb.tab', {
    ...
    this.activate($target, $target.parent(), function () {
      $this.trigger({
        type: 'http://avtoservice.ssd-media.ru/components/com_sppagebuilder/assets/js/shown.sppb.tab',
        relatedTarget: previous
      })
    })
  }
  ...
  function Plugin(option) {
    return this.each(function () {
      var $this = $(this)
      var data  = $this.data('http://avtoservice.ssd-media.ru/components/com_sppagebuilder/assets/js/sppb.tab')

      if (!data) $this.data('http://avtoservice.ssd-media.ru/components/com_sppagebuilder/assets/js/sppb.tab', (data = new SPPBTab(this)))
...
+function ($) {
  ...
  if (!$.fn.sppbtooltip) throw new Error('Popover requires tooltip-1.js'/*tpa=http://avtoservice.ssd-media.ru/components/com_sppagebuilder/assets/js/Popover requires tooltip.js*/)
